...
void I2C_Init (uint32_t frecuencia);
void I2C_Start (void);
...
void LCD_Write_Nibble(uint8_t n)
{
  LATCbits.LC0 = RS;
  LATDbits.LD4 = n & 0x01;
  LATDbits.LD5 = (n >> 1) & 0x01;
  LATDbits.LD6 = (n >> 2) & 0x01;
  LATDbits.LD7 = (n >> 3) & 0x01;
